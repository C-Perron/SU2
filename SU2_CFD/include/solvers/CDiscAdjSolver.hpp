...
protected:
  ...
  vector<su2double>
    Total_Sens_EngineInflow_Target,
    Total_Sens_Exhaust_Temperature_Target,
    Total_Sens_Exhaust_Pressure_Target,
    EngineInflow_Target,
    Exhaust_Temperature_Target,
    Exhaust_Pressure_Target;
